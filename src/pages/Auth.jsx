      ...
      <div className="flex min-h-screen flex-col text-[#242424]">
        <div className="flex grow items-center justify-center">
          <div className="flex h-[60vh] w-[25%] overflow-hidden rounded-lg border border-white/40 bg-white/15 opacity-[0.99] shadow-[0_8px_32px_rgba(0,0,0,0.15),_inset_0_1px_0_rgba(255,255,255,0.2)] backdrop-blur-[15px]">
            <form className="flex w-full flex-col items-center space-y-3 p-8">
              <h1 className="mb-5 self-center text-xl font-semibold">Login into your account</h1>

              <p className="text-md self-start pt-2 font-medium">
                Email address
              </p>
              <input
                type="email"
              ...
              <p className="text-m self-start pt-2 font-medium">Password</p>
              <input
                type="password"
                className="h-10 w-full max-w-[400px] rounded-md border border-black/40 bg-white pl-3 text-sm font-normal outline-none focus:ring-2 focus:ring-blue-500"
              />
              ...
              <button
                type="submit"
                className="mt-5 h-10 w-full max-w-[400px] cursor-pointer rounded-md border border-[rgba(255,255,255,0.15)] bg-[#2ea043] text-sm font-normal text-white transition-colors outline-none hover:bg-[#238636]"
              >
                Login
              </button>
              ...
              <button
                type="button"
                className="mt-3 flex h-10 w-full max-w-[400px] cursor-pointer items-center justify-center gap-3 rounded-md border border-white bg-gray-700 text-sm font-normal text-white transition-colors outline-none hover:bg-gray-800"
              >
                <FaGithub size={20} />
