...
const ulClass =
  "flex items-center justify-start gap-5 text-[14px] font-normal text-white text-opacity-60 ml-5";
const inputClass =
  "placeholder-white/60 text-white bg-[#2C2C2C] w-96 h-12 rounded-2xl pl-11 font-normal";
